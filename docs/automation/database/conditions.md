...
Эти условия являются контейнерами для других условий. Условие `"AND"` будет считаться выполенным, если _все_ вложенные условия будут выполены. Условие `"OR"` будет считаться выполенным, если _хотя бы одно_ из вложенных условий будет выполено. Условие `"NOT"` будет считаться выполенным, если _ни одно_ вложенное условие _не_ будет выполено. Условия могут быть вложены друг в друга рекурсивно, сколько угодно раз.
