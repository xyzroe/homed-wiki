...
| <div style="width:100px">Параметр</div> | Описание |
|-----------------------------------------|----------|
...
| `cloud`   | состояние функции [HOMEd Cloud](/cloud/index.html) для новых устройств по умолчанию |
...
| `expose`     | путь к файлу с [опциями](/common/options.md) типовых [способностей устройств](/common/exposes.md) устройств |
...
| <div style="width:100px">Параметр</div> | Описание |
|-----------------------------------------|----------|
| `adapter`  | тип адаптера, возможные значения:<br>`ezsp`, `zboss`, `zigate`, `znp` |
...
| `reset`    | способ управления перезагрузкой координатора, возможные значения:<br>`gpio`, `flow`, `soft` |
...
## Что дальше?
После настройки _HOMEd ZigBee_ можно приступать к добавлению устройств в сеть, при помощи [веб-интерфейса](/web/) или [вручную](topics.md).
